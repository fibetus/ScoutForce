...
3. Pracownicy klubu dzielą się dalej m.in. na dyrektorów i skautów. Każdy pracownik jest dokładnie jednym z tych dwóch typów, w przyłości mogą zostać dodane kolejne typy pracownika. Dla każdego pracownika oprócz danych osobowych pamiętamy: datę zatrudnienia oraz dzienną stawkę wynagrodzenia.
...
11. Każdy zawodnik posiada w systemie status z procesu skautingowego: "new", "observed", "medical verification", "invited to workout", "invited to Big Board", "delisted". Pomiędzy statusami zdefiniowano dozwolone przejścia (np. przejście "new $arrow$ observed" wymaga utworzenia co najmniej jednego raportu skautingowego dla danego zawodnika).
...
16. Rekomendacja draftowa przyjmuje jedną z czterech wartości: "strong buy" (zdecydowanie pozyskać), "buy" (pozyskać), "neutral" (neutralna) lub "pass" (pominąć).
